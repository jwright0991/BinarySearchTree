...
#@author Josh Wright
#Binary Tree Object Representation: Tree of TreeNodes, each node has between 0-2
...
class BinarySearchTree:
    ...
    #locates and returns the parent node of child in the binary tree(self)
    ...
    #adds node to the binary tree(self) as a child of parent
    ...
    #see the TreeNode __str__ method 
    def __str__(self):
        if self.root == None:
            return "EMPTY"
